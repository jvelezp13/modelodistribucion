"""
Management command para cargar matriz del Oriente Antioqueño
...
from .datos_matriz_oriente import MUNICIPIOS, RUTAS


class Command(BaseCommand):
    help = 'Carga matriz de desplazamientos del Oriente Antioqueño (506 rutas, 23 municipios)'

    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('\n🚀 CARGANDO MATRIZ DEL ORIENTE ANTIOQUEÑO'))
